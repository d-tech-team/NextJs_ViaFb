        ...
        <>
            <Card className="p-3 border-0 shadow-sm">
                ...
                <div>
                    ...
                    <VerticalTimeline layout={'1-column-left'} className={styles.time_line}>
                        ...
                        >
                            <h6><u className="text-primary">ViaFB.VN</u> - <strong className="text-danger">HỆ THỐNG MUA BÁN VIA FACEBOOK UY TÍN, CHẤT LƯỢNG</strong></h6>
                        </VerticalTimelineElement>
                        <VerticalTimelineElement
                        ...
                        >
                            <h6>* TÀI KHOẢN SAU KHI KHÁCH MUA THÌ KHÁCH TỰ BẢO QUẢN (ĐỔI PASS FB VÀ CẢ PASSMAIL). CHÚNG TÔI KHÔNG CHỊU TRÁCH NHIỆM HÀNG BỊ BACK VỀ SAU. VÌ HÀNG SHOP NHẬP TỪ NHIỀU NGUỒN KHÁC NHAU NÊN KHÔNG THỂ ĐẢM BẢO ĐƯỢC LÀ CÓ BỊ ĐẦU NGUỒN BACK HÀNG HAY KHÔNG. TỐT NHẤT KHÁCH NÊN TỰ BẢO QUẢN TÀI SẢN THUỘC QUYỀN SỞ HỮU CỦA MÌNH. XIN CẢM ƠN</h6>
                        </VerticalTimelineElement>
                        <VerticalTimelineElement
                            className="vertical-timeline-element--work"
                            contentStyle={{ background: "#FFEDF0", color: "#000" }}
                        ...
                        >
                            ...
                            <h6>Đọc kĩ "Quy trình Đăng Nhập" để tránh việc bị Checkpoint  <a href=""><strong>ẤN ĐỂ XEM NGAY</strong></a></h6>
                        </VerticalTimelineElement>
                        <VerticalTimelineElement
                            className="vertical-timeline-element--work"
                        ...
                        >
                            ...
                            <h6>+ Vui lòng đăng nhập bằng link <a href="https://mbasic.facebook.com/">https://mbasic.facebook.com/</a> để tránh checkpoint.</h6>
                        </VerticalTimelineElement>
                    </VerticalTimeline>
                </div>
            </Card>
            <div className="mt-5">
                <ProductAndHistory products={products}  histories={[
          {
