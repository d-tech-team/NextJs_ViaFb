            ...
            <Row>
                <Col xs={12} md={6} className={styles.card_wrap}>
                    <Card className={styles.card}>
                        <Card.Header as={'h5'} className={`${styles.title} bg-primary`}>Chấp nhận bảo hành</Card.Header>
                        <Card.Body className={styles.body}>
                            <Card.Text as="div" className={styles.text}>
                                <ol>
                                    <li>Tất cả Via/Clone được bảo hành trong 24h nếu login lần đầu sai pass, checkpoint dạng xác nhận thiết bị.</li>
                                    <li>Bảo hành mất tích 24h đối với mua via XMDT</li>
                                    <li>Thông tin miêu tả Via không đúng với thông tin được ghi trên website khi mua</li>
                                    <li>Tất cả các via khi được mua đều được check live, hoàn 20% nếu bị checkpoint 956 trong 20' đầu kể từ thời gian mua ở website.</li>
                                    <li>Shop chỉ bảo hành login lần đầu qua mbasic.facebook.com mà bị dính checkpoint trong 24 giờ. Login thành công sau đó để bị checkpoint khách tự chịu.</li>
                                </ol>
                            </Card.Text>
                        </Card.Body>
                    </Card>
