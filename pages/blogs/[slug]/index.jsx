...
function BlogDetail() {
    ...
    return (
        <>
            ...
            <PageTitle title="Lorem ipsum dolor sit, amet consectetur !"></PageTitle>
            <Container>
                <p>Tags: mua nick facebook, mua acc facebook, mua nick fb, via 902, via xmdt, via fb, via facebook, via viet, via phi, via indo, mua via xmdt, clone viet, via zin, Acc fb, Mua fb, mua via.
                </p>
                <div>
                    <p>
